...
export default {
  ...
  methods: {
    ...
    registerChart() {
      const registerChart = this.$refs.registerChart  
      const thisRegisterChart = echarts.init(registerChart)
      thisRegisterChart.setOption(this.registerChartOption)
      window.addEventListener("resize", function () {
        thisRegisterChart.resize()  //页面大小变化后Echarts也更改大小
      })
    },
    fwChart() {
      const fwChart = this.$refs.fwChart
      const thisFwChart = echarts.init(fwChart)
      thisFwChart.setOption(this.fwChartOption)
      window.addEventListener("resize", function () {
        thisFwChart.resize()
      })
    }
